...
?>
<!-- wp:cover {"url":"<?php echo esc_url( $hero_img ); ?>","dimRatio":100,"customGradient":"linear-gradient(95deg,#fafaf0 0%,#fafaf0 55%,rgba(250,250,240,0) 92%)","minHeight":720,"align":"full","className":"ciwa-hero"} -->
<div class="wp-block-cover alignfull ciwa-hero" style="min-height:720px">
	...
	<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $hero_img ); ?>" data-object-fit="cover"/>
